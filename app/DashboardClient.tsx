     ...
     setInsertMsg("")
      ...
      <main style={{ background: "var(--panel)", flex: 1,
        ...
        <div style={{ maxWidth: PAGE_MAX, margin: "0 auto" }}>
          ...
          크랙 센서의 시계열 데이터를 기반으로 딥러닝 모델이 브라우저에서 실시간 예측을 수행합니다.
            <br/>
           헤더에는 균열 관리번호와 현장명이 표시됩니다.
파란색 선은 실측값, 빨간색 선은 아신씨엔티 모델의 예측값이며,
빨간색 음영은 95% 예측구간을 나타냅니다.
            <br />
            정확도 = 예측 구간 포함 건수  / 예측 데이터 건수 
          </p>
        </div>
      </main>
    </div>
